...
/* by trashing this card a card costing up to 5 treasure can be obtained */
int feast_function(struct gameState *state, int choice1, int currentPlayer, int *temphand){
...
/*mine card, trash a treasure card an replace it with a card that costs
the value of the trashed treasure plus 3 */
int mine_function(struct gameState *state, int choice1, int choice2, int currentPlayer, int handPos){
    int i;
    int j;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case feast:
        //refactor to separate function
        return feast_function(state, choice1, currentPlayer, temphand);
    ...
    case mine:
        //refactor to separate function
        return mine_function(state, choice1, choice2, currentPlayer, handPos);
